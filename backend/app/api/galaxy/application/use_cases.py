...
from app.api.galaxy.application.dto import GalaxyDetails
from app.api.galaxy.application.ports.galaxy_repository import (
    GalaxyRecord,
    GalaxyRepositoryPort,
)
from app.api.galaxy.domain.rules import default_galaxy_color
...
class GalaxyUseCases:
    ...
    async def _get_owned(self, user_id: uuid.UUID, galaxy_id: uuid.UUID) -> GalaxyRecord:
        """
    ...
    def _to_details(self, galaxy: GalaxyRecord, star_count: int = 0) -> GalaxyDetails:
