...
from app.common.infrastructure.persistence.base import Base, TimestampMixin, new_uuid

if TYPE_CHECKING:
    from app.api.auth.infrastructure.user_model import User
    from app.api.galaxy.infrastructure.galaxy_model import Galaxy
    from app.api.star.infrastructure.view_event_model import ViewEvent
