...
from app.api.star.application.dto import SimilarStar, StarDetails, StarPublicDetails
from app.api.star.application.ports.embedding_provider import EmbeddingProvider
from app.api.star.application.ports.star_repository import StarRecord, StarRepositoryPort
from app.api.star.application.ports.view_event_repository import ViewEventRepositoryPort
from app.api.star.domain.lifecycle import LifecycleState, compute_lifecycle
from app.api.star.domain.placement import place_new_star
from app.api.star.domain.rules import (
    direct_view_energy,
    embedding_source,
...
class StarUseCases:
    ...
    async def _propagate_nova(self, source_star: StarRecord, base_energy: float) -> None:
        """
    ...
    async def _to_response(self, star: StarRecord) -> StarDetails:
        """
    ...
    async def _to_public_response(self, star: StarRecord, username: str) -> StarPublicDetails:
        """
    ...
    async def _get_owned(self, user_id: uuid.UUID, star_id: uuid.UUID) -> StarRecord:
        """
