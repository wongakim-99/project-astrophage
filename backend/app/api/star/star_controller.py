...
from app.api.star.application.dto import SimilarStar, StarDetails
from app.api.star.application.use_cases import StarUseCaseError
from app.api.star.dto.star import (
...
from app.common.dependencies import CurrentUser, StarUseCaseDep
